...
{
    public class ShopSceneManagerTest : MonoBehaviour
{
    [Header("카드 슬롯 UI")]
    public List<CardViewTest> shopCardViews; 
    
    [Header("스티커 슬롯 UI")]
    public List<StickerView> shopStickerViews;

    [Header("카드 구매 버튼")]
    public List<Button> buyCardButtons;
    ...
    public static ShopSceneManagerTest Instance;
