	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_TextureSample = input.ase_texcoord6.xy * _TextureSample_ST.xy + _TextureSample_ST.zw;
				float4 tex2DNode9 = tex2D( _TextureSample, uv_TextureSample );
				
				float2 uv_Ramp = input.ase_texcoord6.xy * _Ramp_ST.xy + _Ramp_ST.zw;
				float4 tex2DNode12 = tex2D( _Ramp, uv_Ramp );
				float temp_output_11_0 = ( tex2DNode9.a * input.ase_color.a );
				...
				float3 Color = ( ( ( input.ase_color * _ExtraGlow ) * _Tint ) * tex2DNode9 ).rgb;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode9 = tex2D( _TextureSample, uv_TextureSample );
				float2 uv_Ramp = input.ase_texcoord3.xy * _Ramp_ST.xy + _Ramp_ST.zw;
				float4 tex2DNode12 = tex2D( _Ramp, uv_Ramp );
				float temp_output_11_0 = ( tex2DNode9.a * input.ase_color.a );
				float smoothstepResult36 = smoothstep( ( tex2DNode9.a * ( 1.0 - tex2DNode12 ) ).r , 1.0 , temp_output_11_0);
				float clampResult44 = clamp( smoothstepResult36 , 0.0 , 1.0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float4 tex2DNode9 = tex2D( _TextureSample, uv_TextureSample );
				float2 uv_Ramp = input.ase_texcoord.xy * _Ramp_ST.xy + _Ramp_ST.zw;
				float4 tex2DNode12 = tex2D( _Ramp, uv_Ramp );
				float temp_output_11_0 = ( tex2DNode9.a * input.ase_color.a );
				float smoothstepResult36 = smoothstep( ( tex2DNode9.a * ( 1.0 - tex2DNode12 ) ).r , 1.0 , temp_output_11_0);
				float clampResult44 = clamp( smoothstepResult36 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.SamplerNode;12;-991.7396,574.1258;Inherit;True;Property;_Ramp;Ramp;3;0;Create;True;0;0;0;False;0;False;-1;None;42db998579832c148abb2fefeaa9946b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;9;-914.5962,62.23823;Inherit;True;Property;_TextureSample;Texture Sample;2;0;Create;True;0;0;0;False;0;False;-1;None;42db998579832c148abb2fefeaa9946b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;6;-909.7548,-76.40013;Inherit;False;Property;_Tint;Tint;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;45;-1012.946,880.9207;Inherit;True;Property;_Cloud;Cloud;4;0;Create;True;0;0;0;False;0;False;-1;2d915baa3c0f2374ab12f9bdc8891d5c;42db998579832c148abb2fefeaa9946b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;59;256,32;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Archanor VFX/Retro Arsenal/Disintegrate;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;9;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;27;Surface;1;638528673294233478;  Blend;0;0;Two Sided;0;638528673283071665;Alpha Clipping;1;0;  Use Shadow Threshold;0;0;Forward Only;0;0;Cast Shadows;1;0;Receive Shadows;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;True;True;False;False;True;True;True;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;69;256,132;Float;False;False;-1;3;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=71C1855282F1CCDD56C374D40CCB497657A87901