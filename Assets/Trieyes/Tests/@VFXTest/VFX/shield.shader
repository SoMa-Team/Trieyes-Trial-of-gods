...
Shader "Vefects/SH_Vefects_URP_2D_Unlit_Flipbook_Pixel_Color_01"
{
	Properties
	{
		...
		_OverallTint("Overall Tint", Color) = (1,1,0,0)
		_HueShift("Hue Shift", Range( 0 , 1)) = 0
		_SaturationMultiply("Saturation Multiply", Float) = 1.5
		_Emissive("Emissive", Float) = 2.5
		_LightningIntensity("Lightning Intensity", Range( 0 , 5)) = 2
		_LightningSpeed("Lightning Speed", Range( 0.1 , 10)) = 3
		_LightningScale("Lightning Scale", Range( 0.1 , 3)) = 1.2
